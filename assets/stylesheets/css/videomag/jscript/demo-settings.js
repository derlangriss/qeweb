...
jQuery(document).ready(function() {
	...
	jQuery(".demo-settings").append("<div class='demo-options'>"+
										...
										"<a href='#demo' rel='font-options' class='option'><img src='assets/videomag/images/px.gif' width='32' height='32' class='demo-icon f1' alt='' /><span>Font Settings</span><font>Change Fonts</font></a>"+
										"<div class='option-box' rel='font-options'>"+
											...
											"</div>"+
										"</div>"+
										"<a href='#demo' rel='color-options' class='option'><img src='assets/videomag/images/px.gif' width='32' height='32' class='demo-icon f2' alt='' /><span>Color Options</span><font>Color schemes</font></a>"+
										...
										"<div class='option-box sequal' rel='color-options'>"+
											...
											"</div>"+
										"</div>"+
										"<a href='#demo' rel='page-header' class='option'><img src='assets/videomag/images/px.gif' width='32' height='32' class='demo-icon f6' alt='' /><span>Change Header</span><font>Choose Header Style</font></a>"+
										...
										"<div class='option-box sequal' rel='page-header'>"+
											...
											"</div>"+
										"</div>"+
										"<a href='#demo' rel='background' class='option'><img src='assets/videomag/images/px.gif' width='32' height='32' class='demo-icon f3' alt='' /><span>Background</span><font>Backgorund textures</font></a>"+
										"<div class='option-box' rel='background'>"+
											"<div alt='background'>"+
												...
												"<a href='#' class='color-bulb' style='background: url(assets/videomag/images/background-texture-3.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: url(assets/videomag/images/background-texture-1.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: url(assets/videomag/images/background-texture-2.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: url(assets/videomag/images/background-texture-4.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: url(assets/videomag/images/background-texture-5.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background-image: url(assets/videomag/images/background-photo-1.jpg);background-size: 100%; background-attachment: fixed;'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background-image: url(assets/videomag/images/background-photo-2.jpg);background-size: 100%; background-attachment: fixed;'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background-image: url(assets/videomag/images/background-photo-3.jpg);background-size: 100%; background-attachment: fixed;'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background-image: url(assets/videomag/images/background-photo-4.jpg);background-size: 100%; background-attachment: fixed;'>&nbsp;</a>"+
											"</div>"+
										"</div>"+
										"<a href='#demo' rel='page-width' class='option'><img src='assets/videomag/images/px.gif' width='32' height='32' class='demo-icon f4' alt='' /><span>Change Width</span><font>Boxed or Full-Width</font></a>"+
