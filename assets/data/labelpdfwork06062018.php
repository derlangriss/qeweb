...
foreach ($resultArray as $row) //Extract the Array Values by using Foreach Loop
{
    ...
    $strSQL02 = " SELECT coll_id,coll_full_id,collector_firstname_en,collector_lastname_en FROM collection_has_collector
 ...
 */
        ...
        while ($obResult02 = pg_fetch_array($objQuery02)) {
            ...
            if ($test == 1) {
                $arrCol02['collectorfullall'] = $resultCollector[0]['collector_firstname_en'] . " " . $resultCollector[0]['collector_lastname_en'] . ", " . $arrCol02['collector_firstname_en'] . " " . $arrCol02['collector_lastname_en'];
