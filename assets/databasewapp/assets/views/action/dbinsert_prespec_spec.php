                ...
                if ($intRowsColl01 > 0) {
                    ...
                    for ($i = 1; $i <= $preins_spec_qty; $i++) {
                        ...
                        if ($intRowsCollCheck > 0) {
                            ...
                            echo $specimens_trash_n." ".$specimens_id;
                            ...
                            $strSQL02 .= "(collection_coll_id, specimens_number, specimens_full_number,labelor_labelor_id,sreport_date)";
                            $strSQL02 .= "VALUES ";
                            $strSQL02 .= "('" . $preins_collid . "','" . $specimens_numberplus . "','" . $specimens_full_number . "','" . $preins_staff_id . "','" . $preins_date . "')";
                    ...
                    for ($i = 1; $i <= $preins_spec_qty; $i++) {
                        ...
                        if ($intRowsCollCheck > 0) {
                            ...
                            $strSQL05 .= "(collection_coll_id, specimens_number, specimens_full_number,labelor_labelor_id,sreport_date)";
                            $strSQL05 .= "VALUES ";
                            $strSQL05 .= "('" . $preins_collid . "','" . $specimens_numberplus . "','" . $specimens_full_number . "','" . $preins_staff_id . "','" . $preins_date . "')";
