...
function createFileFromChunks($temp_dir, $fileName, $chunkSize, $totalSize) {
    ...
    if ($total_files * $chunkSize >=  ($totalSize - $chunkSize + 1)) {
        ...
        if (($fp = fopen('img/uploads/collector'.$fileName, 'w')) !== false) {
...
// THE SCRIPT
////////////////////////////////////////////////////////////////////
$tempDir = __DIR__ . DIRECTORY_SEPARATOR . 'img'. DIRECTORY_SEPARATOR .'uploads'. DIRECTORY_SEPARATOR .'collector';
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $temp_dir = $tempDir.DIRECTORY_SEPARATOR.$_POST['flowIdentifier'];
...
if (!empty($_FILES)) foreach ($_FILES as $file) {
    ...
    $temp_dir = $tempDir.DIRECTORY_SEPARATOR.$_POST['flowIdentifier'];
    $dest_file = $temp_dir.DIRECTORY_SEPARATOR.$_POST['flowFilename'].'.part'.$_POST['flowChunkNumber'];
