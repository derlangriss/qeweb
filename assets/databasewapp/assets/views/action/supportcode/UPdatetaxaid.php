...
select pretaxacode,pretaxayear,pretaxanumber,pretaxasnumber,pretaxaorder,torder_id,pretaxa_id
from pretaxa
left join torder on  pretaxa.pretaxaorder = torder.torder_name
where torder_id IS NULL


select pretaxacode,pretaxayear,pretaxanumber,pretaxasnumber,pretaxafamily,family_id,pretaxa_id
from pretaxa
left join family on  pretaxa.pretaxafamily = family.family_name
where family_id IS NULL