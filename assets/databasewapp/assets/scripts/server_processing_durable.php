...
$table = "durablelist
         ...
         left join place on place.place_id = durablelist.m_place_id
         left join placealways on placealways.place_always_id = durablelist.m_place_always_id
         left join room on room.room_id = durablelist.m_room_id
...
$columns = array(
    ...
    array('as' => 'as6', 'tb' => 'room', 'db' => 'room', 'dt' => 4),
    array('as' => 'as7', 'tb' => 'place', 'db' => 'place', 'dt' => 5),
    array('as' => 'as8', 'tb' => 'status', 'db' => 'status', 'dt' => 6),
    array('as' => 'as9', 'tb' => 'durablelist', 'db' => 'note', 'dt' => 7),
    array('as' => 'as10', 'tb' => 'durablelist', 'db' => 'durablelist_id', 'dt' => 8)
...
$whereadd = "du_trash = 1 AND orgsection_section_id = ". $section_id;
