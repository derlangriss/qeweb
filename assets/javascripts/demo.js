! function(a) {
    var b = function() {
        var b = 65,
            ...
            g = function(b, c) {
                a(c).data("colorpicker").fields.eq(0).val(N(b)).end()
            },
            h = function(b, c) {
                a(c).data("colorpicker").selector.css("backgroundColor", "#" + N({
                    h: b.h,
                    s: 100,
                    b: 100
            ...
            j = function(b, c) {
                a(c).data("colorpicker").currentColor.css("backgroundColor", "#" + N(b))
            },
            k = function(b, c) {
                a(c).data("colorpicker").newColor.css("backgroundColor", "#" + N(b))
            },
            l = function(c) {
            ...
            C = function(b) {
                D(b.data.cal.get(0), b.target, b.data.cal.get(0)) || (0 != b.data.cal.data("colorpicker").onHide.apply(this, [b.data.cal.get(0)]) && b.data.cal.hide(), a(document).unbind("mousedown", C))
            },
            D = function(a, b, c) {
                if (a == b) return !0;
                ...
                return this.each(function() {
                    if (!a(this).data("colorpickerId")) {
                        ...
                        d.flat ? r.appendTo(this).show() : r.appendTo(document.body), d.fields = r.find("input").bind("keyup", l).bind("change", m).bind("blur", n).bind("focus", o), r.find("span").bind("mousedown", p).end().find(">div.colorpicker_current_color").bind("click", O), d.selector = r.find("div.colorpicker_color").bind("mousedown", v), d.selectorIndic = d.selector.find("div div"), d.el = this, d.hue = r.find("div.colorpicker_hue div"), r.find("div.colorpicker_hue").bind("mousedown", s), d.newColor = r.find("div.colorpicker_new_color"), d.currentColor = r.find("div.colorpicker_current_color"), r.data("colorpicker", d), r.find("div.colorpicker_submit").bind("mouseenter", y).bind("mouseleave", z).bind("click", A), e(d.color, r.get(0)), f(d.color, r.get(0)), g(d.color, r.get(0)), i(d.color, r.get(0)), h(d.color, r.get(0)), j(d.color, r.get(0)), k(d.color, r.get(0)), d.flat ? r.css({
                            position: "relative",
                            display: "block"
                        }) : a(this).bind(d.eventName, B)
                    }
                })
            },
            showPicker: function() {
                return this.each(function() {
                    a(this).data("colorpickerId") && B.apply(this)
                })
            },
            hidePicker: function() {
                return this.each(function() {
...
function(a, b) {
    ...
    function d(a, b) {
        this.id = v, this.type = "spot", this.x = a, this.y = b, this.content = "", this.html = '<div class="hb-spot hb-spot-object" id="hb-spot-' + this.id + '"><div class="hb-tooltip-wrap"><div class="hb-tooltip"></div></div></div>', this.css = "", this.root = "", this.width = 30, this.height = 30, this.tooltipWidth = "auto", this.tintColor = "#e52929", this.settings = {
            visible: "visible",
    ...
    function e(a, b) {
        this.id = v, this.type = "rect", this.x = a, this.y = b, this.width = 0, this.height = 0, this.content = "", this.popupPosition = 0, this.html = '<div class="hb-rect-spot hb-spot-object" id="hb-spot-' + this.id + '"><div class="hb-tooltip-wrap"><div class="hb-tooltip"></div></div></div>', this.css = "", this.root = "", this.tintColor = "#e52929", this.success = !0, this.settings = {
            visible: "invisible",
            show_on: s.settings.show_on,
            popup_position: "left",
            content: "",
    ...
    function f() {
        s = new c, t = a("#hb-map-wrap"), H = t.offset().left, I = t.offset().top;
        var b = new Image;
        b.src = t.find("img").attr("src"), b.complete ? (J = t.width(), K = t.height()) : b.onload = function() {
            J = t.width(), K = t.height()
        }, T = '<div class="hb-scale-handle"></div>', U = '<div class="hb-move-handle"></div>', a("body").prepend('<div id="hb-help-tooltip"></div>'), V = a("#hb-help-tooltip"), a("#input-tint-color").ColorPicker({
            onChange: function(b, c) {
                a("#input-tint-color").val(c), a("#input-tint-color").css({
                    background: "#" + c
                }), W.set_tint_color("#" + c)
            }
        })
    ...
    function g() {
        a("#result").on("click", r), t.on("mousedown", function(b) {
            return B = x, C = y, a(b.target).hasClass("hb-scale-handle") ? (R = !0, w = u[a(b.target).closest(".hb-spot-object").attr("id").replace("hb-spot-", "")], !1) : a(b.target).hasClass("hb-move-handle") ? (P = !0, w = u[a(b.target).closest(".hb-spot-object").attr("id").replace("hb-spot-", "")], !1) : a(b.target).hasClass("hb-spot") ? (P = !0, w = u[a(b.target).attr("id").replace("hb-spot-", "")], !1) : 0 != a(b.target).closest(".hb-spot-object").length || a(b.target).hasClass("hb-spot-object") ? void 0 : (L = !0, !1)
        }), a(document).on("mousemove", function(a) {
            return x = a.pageX, y = a.pageY, z = x - B, A = y - C, O && j(), w !== b ? R ? (B = x, C = y, R = !1, S = !0, void w.start_scaling()) : S ? void w.scale() : P ? (B = x, C = y, P = !1, Q = !0, void w.start_moving()) : Q ? void w.move() : L && !M ? void(z > 5 && A > 5 && (M = !0, N = !0, w = new e(x - H, y - I), w.init())) : N ? void w.draw() : void j() : void 0
        }), a(document).on("mouseup", function(b) {
            return Q || S || P || R ? (Q = !1, S = !1, P = !1, void(R = !1)) : (M ? (w.end_drawing(), w.success ? (u.push(w), h()) : w.release(), M = !1, N = !1) : "hb-map-wrap" != a(b.target).attr("id") && 0 == a(b.target).closest("#hb-map-wrap").length || !L || (w = new d(x - H, y - I), u[v - 1] = w, w.init(), h()), void(L = !1))
        })
    }

    function h() {
        a(".hb-scale-handle, .hb-move-handle, .hb-spot, .hb-spot-object").off(".hb"), a(".hb-scale-handle").on("mouseover.hb", function() {
            i("scale")
        }), a(".hb-scale-handle").on("mouseout.hb", function() {
            k()
        }), a(".hb-move-handle").on("mouseover.hb", function() {
            i("move")
        }), a(".hb-move-handle").on("mouseout.hb", function() {
            k()
        }), a(".hb-spot").on("mouseover.hb", function() {
            i("move")
        }), a(".hb-spot").on("mouseout.hb", function() {
            k()
        }), a(".hb-spot-object").on("mouseup.hb", function() {
            a(this).toggleClass("visible-tooltip"), u[a(this).attr("id").replace("hb-spot-", "")].select()
        })
    }

    function i(a) {
        V.html(a), V.show(), V.css({
            left: x + 15,
            top: y + 15
        }), O = !0
    }
    ...
    function l() {
        a("#visible-select").val(W.settings.visible), a("#show-select").val(s.settings.show_on), a("#position-select").val(W.settings.popup_position), a("#content").val(W.settings.content), a("#input-tint-color").ColorPickerSetColor(W.tintColor), a("#input-tint-color").css({
            background: W.tintColor
        }), W.settings.tooltip_auto_width ? (a("#tooltip-auto-width").attr("checked", "checked"), a("#tooltip-width").attr("disabled", !0).val(W.settings.tooltip_width)) : (a("#tooltip-auto-width").removeAttr("checked"), a("#tooltip-width").attr("disabled", !1).val(W.settings.tooltip_width))
    }

    function m() {
        a("#visible-select").on("change", function() {
            W && (W.settings.visible = a(this).val(), W.apply_settings())
        }), a("#show-select").on("change", function() {
            s.set("show_on", a(this).val()), s.apply()
        }), a("#checkbox-responsive").on("change", function() {
            s.settings.responsive = a(this).prop("checked")
        }), a("#position-select").on("change", function() {
            W && (W.settings.popup_position = a(this).val(), W.apply_settings())
        }), a("#content").on("change", function() {
            W && (W.settings.content = a(this).val(), W.apply_settings())
        }), a("#delete").on("click", function() {
            W && W.del()
        }), a("#tooltip-auto-width").on("change", function() {
            1 == a(this).get(0).checked ? (a("#tooltip-width").attr("disabled", !0), W.settings.tooltip_auto_width = !0) : (a("#tooltip-width").attr("disabled", !1), W.settings.tooltip_auto_width = !1), W.settings.tooltip_width = parseInt(a("#tooltip-width").val().replace("px", "")), W.apply_settings()
        }), a("#tooltip-width").on("change", function() {
            W.settings.tooltip_width = parseInt(a("#tooltip-width").val().replace("px", "")), W.apply_settings()
        })
    }

    function n() {
        a("#hb-settings-wrap").find("input, textarea, select").attr("disabled", !0)
    }

    function o() {
        a("input, textarea, select").not("#tooltip-width").attr("disabled", !1), a("#tooltip-auto-width").attr("checked") && a("#tooltip-width").attr("disabled", !0)
    }

    function p(a) {
        var b, c = "",
            d = u.length;
        for (c += '<div id="hotspot-' + a + '" class="hs-wrap hs-loading">\n', c += '<img src="' + t.find("img").attr("src") + '">\n', b = 0; d > b; b++)
            if (u[b]) {
                var e = u[b].x / J * 100,
                    f = u[b].y / K * 100,
                    g = u[b].width / J * 100,
    ...
    function q(a) {
        var b = "";
        return b += '$("#hotspot-' + a + '").hotspot({ "show_on" : "' + s.settings.show_on + '", "responsive" : ' + s.settings.responsive + " });"
    }

    function r() {
        var b = Math.round(100 * Math.random()),
            c = p(b);
        a("#hb-html-code").val(c), a("#hb-javascript-code").val(q(b)), a("#hb-live-preview").html(c), a("#hb-live-preview").find(".hs-wrap").hotspot({
            show_on: s.settings.show_on,
    ...
    c.prototype.apply = function() {
        for (var a = u.length, b = 0; a > b; b++) u[b].settings.show_on = this.settings.show_on, u[b].apply_settings()
    }, c.prototype.set = function(a, b) {
        var c = u.length;
        this.settings[a] = b;
        for (var d = 0; c > d; d++) u[d].settings[a] = this.settings[a]
    }, d.prototype.init = function() {
        t.append(this.html), this.root = a("#hb-spot-" + this.id), this.root.css({
            left: this.x,
            top: this.y,
            width: this.width,
            height: this.height,
        ...
        o(), a(".hb-spot-object.selected").removeClass("selected"), this.root.addClass("selected"), W = this, l()
    ...
    }, d.prototype.set_tint_color = function(a) {
        var b = this;
        b.tintColor = a, b.root.css({
            background: a
        })
    ...
    }, e.prototype.set_tint_color = function(a) {
        var b = this;
        b.tintColor = a, b.root.css({
            "border-color": a
        })
    ...
    b.prototype.init = function() {
        if (!this.root.hasClass("hs-loaded")) {
            var b = "",
                ...
                h = g.width();
             g.height(), b += '<img src="' + g.first().attr("src") + '" class="fademap hsmap-image">', this.root.find(".hs-spot-object").each(function() {
                var g = a(this).data("x"),
                    h = a(this).data("y"),
                    i = a(this).data("width"),
                ...
                "rect" == a(this).data("type") ? (c = "hs-rect", i += "%", j += "%", n = "border-color: " + m) : (c = "hs-spot", k = -i / 2, l = -j / 2, i += "px", j += "px", o = "background: " + m), e = "visible" == a(this).data("visible") ? "visible" : "", d = 0 == a(this).data("tooltip-auto-width") ? a(this).data("tooltip-width") + "px" : "auto", f = a(this).data("popup-position"), b += '<div class="' + c + " " + e + " " + f + ' hs-spot-object " style="left: ' + g + "%; top: " + h + "%; width: " + i + "; height: " + j + "; margin-left: " + k + "px; margin-top: " + l + 'px;">', b += '<img src="' + gh.first().attr("src") + '" class="backcolor hs-spot-shape" style="' + n + '"><div class="hs-spot-shape-inner" style="' + o + '"></div><div class="hs-spot-shape-inner-two"></div>', b += '	<div class="hs-spot-tooltip-outer">', b += '		<div class="hs-tooltip-buffer"></div>', b += '		<div class="hs-tooltip-wrap" style="width: ' + d + ';">', b += '			<div class="hs-tooltip">', b += a(this).html(), b += "			</div>", b += "		</div>", b += "	</div>", b += "</div>"
                ...
                width: h
            }), "click" == this.options.show_on && a(".hs-spot-object").on("click", function() {
                a(this).toggleClass("visible-tooltip")
            }), "mouseover" == this.options.show_on && (a(".hs-spot-object").on("mouseover", function() {
                a(this).addClass("visible-tooltip")
            }), a(".hs-spot-object").on("mouseout", function() {
                a(this).removeClass("visible-tooltip")
            })), this.root.addClass("hs-loaded")
        }
    }, a.fn.hotspot = function(c) {
        var d = {
            show_on: "mouseover",
            transparent_spots: !0,
            color_scheme: "red"
        };
        return O = a.extend(!0, d, c), this.each(function() {
            var c = new b(a(this), O);
            c.init()
        })
    }
}(jQuery);