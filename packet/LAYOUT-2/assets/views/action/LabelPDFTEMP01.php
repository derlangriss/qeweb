...
while ($obResult = pg_fetch_array($objQuery)) {
    ...
    $strSQLPrintdetail = "INSERT INTO print_detail ";
    $strSQLPrintdetail .= "(pd_label_type, pd_label_id_to_print,pd_user_request)";
    $strSQLPrintdetail .= "VALUES ";
    $strSQLPrintdetail .= "('" . $label_type . "','" . $label_id_to_print . "','" . $user_request . "')";
    $objQueryPrintdetail = pg_query($strSQLPrintdetail);

    $RESprinted = pg_query("UPDATE label_print_queue SET printed_list ='TRUE' WHERE label_id_to_print ='".$label_id_to_print."'");
...
foreach ($resultArray as $row) {
    ...
    $strSQL02 = "  SELECT specimens_id,coll_id,coll_full_id,collector_firstname_en,collector_lastname_en,specimens_full_number,province_en,amphur_en,coll_locality,coll_lat_d,coll_lat_m,coll_lat_s,coll_long_d,coll_long_m,coll_long_s,coll_masl,coll_start_date,coll_end_date,method,collectorseq FROM label_print_queue
                    ...
                    ORDER BY specimens_full_number ASC,collectorseq ASC";
