...
\fancyhead[C]{\begin{tabular}[t]{>{\centering\arraybackslash}p{10cm}@{}}
  ...
  \textbf{ประเภท :} 
	\begin{Form}
	\hfill{} \makebox[5pt][l]{\Large $\square$}\raisebox{.8ex}{\hspace{0.5em}}  ครุภัณฑ์
	\hfill{} \makebox[5pt][l]{\Large $\square$}\raisebox{.8ex}{\hspace{0.5em}}  วัสดุคงทน
	\hfill{} \makebox[5pt][l]{\Large $\square$}\raisebox{.8ex}{\hspace{0.5em}}  สิ่งก่อสร้าง
	\end{Form}
\end{tabular}}
