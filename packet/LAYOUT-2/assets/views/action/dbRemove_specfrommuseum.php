...
if (isset($_POST) && count($_POST)) {
    ...
    $container_type_museum      = 3;
    $specbox_spec_box_id_museum = 0;

    $resultarray = array();

    if ($strMode == "REMOVEFROMMUSEUM") {
        ...
        foreach ($arr_decode_speicmensids as $speicmensids) //Extract the Array Values by using Foreach Loop
        {
            ...
            $res = pg_query("UPDATE specimens SET container_type = '" . $container_type_museum . "' ,specbox_spec_box_id = '" . $specbox_spec_box_id_museum . "' WHERE specimens_id ='" . $speicmensids . "'");
