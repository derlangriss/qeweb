...
if ($CheckUser === 0) {
    ...
    $arr = array('success' => '1', 'countspecinbox' => $countspecinbox, 'countundefinedspec' => $countundefinedspec, 'user_name' => $uppername, 'boxlockstate' => 'LOCK', 'collbox_id' => $collbox_id, 'collboxno' => $collboxno, 'checkuser_date' => $lockbox_mreport, 'nuser_name' => $firstname, 'user_pic' => $avartar);
    array_push($resultArray, $arr);
