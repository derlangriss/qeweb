...
\graphicspath{{E:/programs/xampp/htdocs/Qedatamanagement/packet/LAYOUT-2/assets/images/}}
...
\textbf{\textcolor{orange}{Specimens Of the Month}} & \\
\hline
REPORT DATE & \fulldatereport  \\
QUANTITY & \countspecmonth  \\
...
\NewEnviron{MyTabularX}[2][0]{%
   ...
   \begin{tabularx}{\textwidth}{#2}
    \hline% Print header rows
       \rowcolor{myOrange}  {\textbf{Collection No.}}  & \textbf{Specimens Number} & \textbf{Quantity}  \\ \hline
    \BODY
   \end{tabularx}
}
...
% */  echo "\n" . "\\Data{" . LatexTemplate::escape($reportitem['collfullnum']) . " & " .  /*  
% */  " " . LatexTemplate::escape($reportitem['specimens_number_mixed']) . " & ".    /* 
