 ...
 * AngularJS Directive 
 */
app.controller("DurableMainCtrl", ["$scope", "$uibModal", "$log", "$http", "$timeout", "$stateParams", "SweetAlert", "test",
...
app.controller("DurableNormalCtrl", ["$scope", "$uibModal", "$log", "$http", "$timeout", "$stateParams", "SweetAlert", "test",
    function($scope, $uibModal, $log, $http, $timeout, $stateParams, SweetAlert, test) {
        console.log("sompong")
