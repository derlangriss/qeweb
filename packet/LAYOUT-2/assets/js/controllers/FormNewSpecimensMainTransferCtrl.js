 ...
 * AngularJS Directive  
 */
app.controller("FormNewSpecimensMainTransferCtrl", ["$scope", "$http", "$timeout", "$stateParams", "$state", "SweetAlert", "info", "ngNotify", "ServicePDF", "$aside",
    function($scope, $http, $timeout, $stateParams, $state, SweetAlert, info, ngNotify, ServicePDF, $aside) {
        ...
        $scope.searchmodel = function(i) {
            if (i == 2) {
                ...
                $('#NewSpecimensListTbl').DataTable().column(i).search(ii).draw();
            }
            if (i == 3) {
        ...
        var groupColumn = 2;
        var groupColumn1 = 3;
        var tableSpecReportList = $('#NewSpecimensListTbl').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
        ...
        /** datatable checkbox **/
        $('#NewSpecimensListTbl tbody').on('click', '.select-checkbox', function() {
            var tr = $(this).closest('tr');
        ...
        $('#NewSpecimensListTbl tbody').on('click', '.checkall', function() {
        ...
        $('#NewSpecimensListTbl tbody').on('click', '.cancelall', function() {
