 ...
 * AngularJS Directive  
 */
app.controller("SpecimensReportCtrl", ["$scope", "$uibModal", "$log", "$http", "$timeout", "$stateParams", "SweetAlert", "info", "ngNotify", "calculatedbData", function($scope, $uibModal, $log, $http, $timeout, $stateParams, SweetAlert, info, ngNotify, calculatedbData) {
    $scope.specdata = {};
    ...
    var table = $('#preInsSpecTbl').DataTable({
        ...
        "pagingType": "input",
        "dom": "<'row'<'col-sm-6'B><'col-sm-6'p>>" + "<'row'<'col-sm-12 margin-bottom-10'tr>>" + "<'row'<'col-sm-12'i> >",
        "scrollX": true,
        "scrollY": "500px",
        "scrollCollapse": true,
        "lengthMenu": [
