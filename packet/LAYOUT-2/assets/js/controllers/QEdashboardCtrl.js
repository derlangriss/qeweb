...
function($scope) {
	$scope.labels = ['2555', '2556', '2557', '2558', '2559', '256', '2561', '2562'];
	$scope.series = ['specimensall','specimesngrowth'];
	$scope.data = [[5400, 5400, 5400, 5400, 5400, 5400, 5400, 5400],[40000, 45400, 54000, 64000, 71400, 855400, 95400, 105400]];
	$scope.colors = [{
...
function($scope) {
	$scope.labels = ['2555', '2556', '2557', '2558', '2559', '2560', '2561', '2562'];
	$scope.series = ['ได้รับมา', 'ใช้ไป'];
	$scope.data = [[330000,330000 , 330000, 330000, 330000, 330000, 330000,330000], [330000,330000 , 330000, 330000, 330000, 330000, 330000,330000]];
	$scope.colors = [{
