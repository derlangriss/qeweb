 ...
 * AngularJS Directive  
 */ 
app.controller("FormSpecimenDataCtrl", ["$scope", "$http", "$timeout", "$stateParams", "SweetAlert", "info", "ngNotify", function($scope, $http, $timeout, $stateParams, SweetAlert, info, ngNotify) {
    $scope.specdata = {};
    $scope.savetype = 1;
