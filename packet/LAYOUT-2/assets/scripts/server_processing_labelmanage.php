...
$columns = array(
    ...
    array('as' => 'as3', 'tb' => 'specimens', 'db' => 'record_timestamp', 'dt' => 1),
    array('as' => 'as4', 'tb' => 'specimens', 'db' => 'sreport_month', 'dt' => 2),
    array('as' => 'as5', 'tb' => 'specimens', 'db' => 'sreport_year', 'dt' => 3),
    array('as' => 'as6', 'tb' => 'specimens', 'db' => 'sreport_date', 'dt' => 4),
    array('as' => 'as7', 'tb' => 'specimens', 'db' => 'spec_print_prelist', 'dt' => 5),
    ...
    array('as' => 'as11', 'tb' => 'specimens', 'db' => 'record_timestamp', 'dt' => 9),
...
$whereadd = "specimens_trash = 1 AND print_status = 'TRUE'";
if (isset($_POST) && count($_POST)) {
    ...
    if ($report_month && $report_year === '') {
        ...
        $whereadd .= "AND EXTRACT(MONTH FROM sreport_date) = " . $_POST['treport_month'] . " AND EXTRACT(YEAR FROM sreport_date) = " . $_POST['treport_year'];
    }
}
