...
$table = "durablelist
         ...
         left join orgsection on orgsection.orgsection_id = durablelist.orgsection_orgsection_id";
...
$columns = array(
    ...
    array('as' => 'as12', 'tb' => 'orgsection', 'db' => 'orgsection', 'dt' => 10),
...
$whereadd = "du_trash = 1 AND orgsection_id = ". $section_id." AND status_id = ".$status_id;
