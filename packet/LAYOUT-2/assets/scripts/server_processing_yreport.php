...
$columns = array(
    ...
    array('as' => 'as11', 'tb' => 'specimens', 'db' => 'sreport_date', 'dt' => 9),
);
...
if (isset($_POST) && count($_POST)) {
    $mreport_date = $_POST['mreport_date'];
    $date         = str_replace('/', '-', $mreport_date);
    ...
    if ($mreport_date == '') {
        ...
        $whereadd = "EXTRACT(MONTH FROM sreport_date) = " . $month . " AND EXTRACT(YEAR FROM sreport_date) = " . $year;
    }
}

/*
$whereadd = "spec_print_prelist = 'TRUE' EXTRACT(MONTH FROM sreport_date) = ".$mreport_date;*/
